...
from homeassistant.const import CONF_ACCESS_TOKEN, CONF_HOST, CONF_PORT, CONF_TIMEOUT
...
COMMAND_REQUEST_CHALLENGE = b"request_challenge\n"
COMMAND_SHUTDOWN = "shutdown"
COMMAND_ADMIN_SHUTDOWN = "admin_shutdown"
    ...
    def shutdown(host, port, secret, force, socket_timeout):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as conn:
            ...
            try:
                ...
                conn.send(COMMAND_REQUEST_CHALLENGE)
